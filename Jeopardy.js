...
$(".g4").on("click", function (){
    swal({
        text:"In this game you kill zombies working as a secret agent?",
        buttons:{
            A:"Dead Island",
            B:"Resident Evil",
            C:"Dead Or Alive",
...
$(".m1").on("click", function (){
    swal({
        text:"In this movie kelvin hart was hired to be a best man?",
        buttons:{
            A:"Seriously Funny",
            B:"Ride Along",
            C:"Night School",
...
$(".mo1").on("click", function (){
    swal({
        text:"This president is on the 1 dollar bill?",
        buttons:{
            A:"Abraham Lincoln",
            B:"Benjamin Franklin",
            C:"Andrew Jackson",
